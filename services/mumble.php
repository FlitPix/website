    ...
    <body>
        <div id="wrap">
            ...
            <div id="main">
                ...
                <p><b>NOTICE:</b> The bridge currently doesn't function correctly on its own. I've reached out to the developer in hopes to get it working again. I will sometimes start it myself, but this is completely manual. This section is written as if the bridge was working correctly. For more information, see the "Known issues" section below.</p>
                ...
                <h3>Known issues</h3>
                <ul>
                    <li><b>Server:</b> Self-signed certificate is generated by Mumble for now. You will need to accept the certificate when joining for the first time. Will fix, though it's been painful to try and figure out.</li>
                    <li><b>Discord Bridge:</b> In solo testing, there are times where, on Discord, bridged audio will be somewhat quiet at first before getting louder later. I can't tell if this is my audio setup or if it's some weirdness with the bridge. It might not come up with multiple people, we'll see.</li>
                    <li><b>Discord Bridge:</b> Text chat <a href="https://github.com/Stieneee/mumble-discord-bridge/issues/82">doesn't bridge from Discord to Mumble</a>, and commands <a href="https://github.com/Stieneee/mumble-discord-bridge/issues/43">don't work on Discord</a>. We currently use <a href="https://github.com/Discord-TTS/Bot">TTS Bot</a> on the Discord side as a workaround.</li>
                    <li><b>Discord Bridge:</b> Auto mode <a href="https://github.com/Stieneee/mumble-discord-bridge/issues/83">doesn't work</a>.</li>
                </ul>
            </div>
